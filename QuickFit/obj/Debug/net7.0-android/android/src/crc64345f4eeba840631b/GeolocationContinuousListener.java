...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GeolocatorPlugin.Platforms.Android.GeolocationContinuousListener, GeolocatorPlugin", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener ()
	{
		...
		if (getClass () == GeolocationContinuousListener.class) {
			mono.android.TypeManager.Activate ("GeolocatorPlugin.Platforms.Android.GeolocationContinuousListener, GeolocatorPlugin", "", this, new java.lang.Object[] {  });
		}
	}
